...
a persistence unit "OrellanaPulla-Luis-ExamenPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ec/edu/ups/OrellanaPulla_Luis_Examen/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "OrellanaPulla-Luis-Examen/pom.xml":
...
artifact ("OrellanaPulla-Luis-Examen.war") is already built. You can build
